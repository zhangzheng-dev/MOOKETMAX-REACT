...
export function FactoryProductCard({card, onPress}: Props) {
...
const styles = StyleSheet.create({
  ...
  priceValue: {fontFamily: fonts.manropeBold, color: colors.primary, fontSize: 20, lineHeight: 26},
  ...
  rowPrice: {fontFamily: fonts.manropeSemiBold, color: colors.primary, fontSize: 12, lineHeight: 18},
