...
const styles = StyleSheet.create({
  ...
  priceValue: {fontFamily: fonts.manropeBold, color: colors.primary, fontSize: 12, lineHeight: 20},
  priceUnit: {fontFamily: fonts.manropeRegular, color: colors.primary, fontSize: 10, lineHeight: 20},
